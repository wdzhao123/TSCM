...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha', default=0.1, type=float, help='Alpha hyper-parameter which controls Inter-class '
                                                                 'Dispersion Metric')
    parser.add_argument('--gamma', default=0.5, type=float, help='Beta hyper-parameter which controls Intra-class '
                                                                 'Interaction Metric')
    parser.add_argument('--beta', default=0.5, type=float, help='Gamma hyper-parameter which controls Intra-class '
                                                                'Compactness Metric')
